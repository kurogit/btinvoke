 ...
 * Better Log Class.
 * 
 * Wrapper around android.util.Log. Checks for {@link BuildConfig#DEBUG}. Also tries to gain some performance by
...
public final class BetterLog {
     ...
     * @param msg Format message that should be logged.
