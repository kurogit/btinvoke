 ...
 * object is also called from the UI thread, the broadcast containing the result can never be
 * received. Therefore, methods on an Proxy created with this {@code InvocationHandler} should never
...
public class BTInvocationHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] params) throws Throwable {
        ...
        BTInvoke.remoteExecute(context_, method.getName(), params);
